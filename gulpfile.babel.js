	...
	return gulp.src ('./src/scss/styles.scss')
        ...
        .pipe(
            clean({
              ...
              safelist: ['search--visible', 'user--visible', 'hamburguer--simple', 'navbar-header--scroll', 'navbar-header--hide', 'navbar-header--hamburguer', 'swiper-pagination-bullet', 'swiper-pagination-bullet-active'],
              FontFace: true,
              variables: true
            })
          )    
